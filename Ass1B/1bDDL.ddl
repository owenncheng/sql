...
COMMENT ON COLUMN payment.date_paid IS
    'date of payment';

COMMENT ON COLUMN payment.class_no IS
    'unique class number to identify class';

COMMENT ON COLUMN payment.facility_rm_no IS
    'the room number of the facility in each centre';

COMMENT ON COLUMN payment.centre_id IS
    'unique id to identify centre';
...
ALTER TABLE payment
    ADD CONSTRAINT payment_pk PRIMARY KEY ( date_paid,
                                            member_no,
                                            class_no,
                                            facility_rm_no,
                                            centre_id );
...
ALTER TABLE payment
    ADD CONSTRAINT payment_nk UNIQUE ( date_paid,
                                       class_no,
                                       facility_rm_no,
                                       centre_id,
                                       member_no );
